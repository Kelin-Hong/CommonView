...
import com.kelin.commonview.indicator.TitleIndicator;
...
public class  TitleIndicatorActivity extends FragmentActivity implements OnPageChangeListener{
    ...
    {
    	 tabs.add(new TabInfo(0, "tab1", false,
	                TestFragment1.class));

	        tabs.add(new TabInfo(1, "tab2",
	                true, TestFragment2.class));

	        tabs.add(new TabInfo(2, "tab3",
	                false, TestFragment3.class));
	        return 0;
    }
